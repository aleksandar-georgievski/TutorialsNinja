...
//    }
//
//    public void getCartProductByName(String cartItem) {
//        boolean item = getCartProductsList().stream().anyMatch(cartProduct ->
//                cartProduct.getText().equalsIgnoreCase(cartItem));
